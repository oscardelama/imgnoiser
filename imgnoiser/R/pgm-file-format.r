...
#
# The original code does not allows to correctly read 16-bit '.pgm'
# files but only 8-bit ones. Seemingly, this code was done when the
# 'pgm' definition did not allow bit depths greater than 8 bits.
