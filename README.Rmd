...
Usage
-----
In [the wiki pages](https://github.com/oscardelama/imgnoiser/wiki) You can find detailed documentation and examples of the general workflow using `imgnoiser`.
