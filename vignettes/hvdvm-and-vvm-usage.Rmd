...
If you don't recall which functions are available in a class isntance, just "print"" it and you will get a list of the class members.
...
my.hvdvm$digest('../data-raw/iso100White.csv', '../data-raw/')
my.vvm$digest('crop_', 240, '../data-raw/')
# 
# imgnoiser.save(my.hvdvm, '../data-raw/my.hvdvm', save.options=FALSE, stop.overwrite=FALSE)
# imgnoiser.save(my.vvm, '../data-raw/my.vvm', save.options=FALSE, stop.overwrite=FALSE)
...
```{r echo=FALSE}
my.vvm$fit.model(model.name = 'weighted', model.family = 'lmrob', weights=1/mean^2)
```
```{r echo=FALSE, message=FALSE, results='hide'}
...
table.print(head(preds), caption='**Model predictions: lm**', align=c('r','r','r','c','r','r'), digits=2)
```
...
```{r, echo = FALSE, comment=" " } 
table.print(head(preds), caption='**Customized Confidence Limits**', align=c('r','r','r','c','r','r'), digits=2)
```
...
table.print(cmp.df, caption="**Predictor vs Source data ranges**", align=c('l','r','r','r','r'))
```
...
```{r, echo = FALSE, comment=" " } 
table.print(head(my.obj$get.model.predictions('weighted')), caption='**Model predictions: Weighted**', align=c('r','r','r','c','r','r'), digits=4)
```
...
table.print(head(preds), caption='**Customized Model predictions**', align=c('r','r'), digits=4)
```
